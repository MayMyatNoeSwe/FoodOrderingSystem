        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('cart') }}" class="relative p-2.5 bg-orange-500 text-white rounded-xl transition-all duration-200 cursor-pointer inline-flex items-center justify-center border border-orange-500 shadow-md">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span
                            x-show="totalQty() > 0"
                            x-text="totalQty()"
                            class="absolute -top-1.5 -right-1.5 bg-white text-orange-500 text-xs font-black min-w-[20px] h-5 px-1 rounded-full flex items-center justify-center shadow-md">
                        </span>
                    </a>
