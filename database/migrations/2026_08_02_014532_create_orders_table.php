...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('delivery_township')->nullable();
            $table->string('region_type')->nullable()->default('yangon');
            ...
            $table->enum('payment_status', ['paid', 'unpaid', 'pending_verification'])->default('unpaid');
